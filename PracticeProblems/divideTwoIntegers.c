...
int divide(int dividend, int divisor){
    ...
    else
    {
        ...
        {
            while(-temp_val<=divisor)
            {// we need to write this way becuse divisor might be -2^31 and cannot be flipped sign with INT
                temp_val+=divisor;
                quotient++;
            }
        }
        ...
        // positive when divisor and dividend sign are the same
